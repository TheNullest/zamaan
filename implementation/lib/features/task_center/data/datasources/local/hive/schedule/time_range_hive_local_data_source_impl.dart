...
class TimeRangeHiveLocalDataSourceImpl extends BaseHiveLocalDataSourceImpl<TimeRangeHiveModel>
    implements TimeRangeLocalDataSource<TimeRangeHiveModel> {
  TimeRangeHiveLocalDataSourceImpl({required super.box});

  @override
  EResultFuture<List<TimeRangeHiveModel>> getByParentId({
    ...
    try {
      ...
      return toFailureEither<List<TimeRangeHiveModel>>(e: e, stackTrace: st);
    }
  }
}
